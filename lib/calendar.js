let calendarClassConnectorAsVariable
...
<div id="calendar-class-container">
    <div id="calendar-class-controls">
        ...
        id="selector-year"
        name="year"
        onchange="calendarClassConnectorAsVariable.moveDate()"
        ></select>
        <select
        id="selector-month"
        name="month"
        ...
        ></select>
        <button
        onclick="calendarClassConnectorAsVariable.moveToday()"
        >
            Today
        </button>

        <button
        onclick="calendarClassConnectorAsVariable.movePreviousMonth()"
        >
            Previous Month
        </button>
        <button
        onclick="calendarClassConnectorAsVariable.moveNextMonth()"
        >
            Next Month
        </button>
    </div>
...
<div class="calendar-class-month">
    ...
    <ul class="calendar-class-day">
        ...
        calendarClassConnectorAsVariable = this
    }
