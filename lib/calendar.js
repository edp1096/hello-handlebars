let calendarClassConnectorVariable
...
<div id="calendar-class-container">
    <div id="calendar-class-controls">
        ...
        id="selector-year"
        name="year"
        onchange="calendarClassConnectorVariable.moveDate()"
        ></select>
        <select
        id="selector-month"
        name="month"
        ...
        ></select>
        <button
        onclick="calendarClassConnectorVariable.moveToday()"
        >
            Today
        </button>

        <button
        onclick="calendarClassConnectorVariable.movePreviousMonth()"
        >
            Previous Month
        </button>
        <button
        onclick="calendarClassConnectorVariable.moveNextMonth()"
        >
            Next Month
        </button>
    </div>
...
<div class="calendar-class-month">
    ...
    <ul class="calendar-class-day">
        ...
        calendarClassConnectorVariable = this
    }
